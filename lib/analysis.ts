...
const NICHE_RUBRICS: Record<string, { direct: string[]; indirect: string[] }> = {
  // Общепит
  coffee: { direct: ["Кофейни", "Кафе-кондитерские"], indirect: ["Пекарни", "Чайные"] },
  doner: { direct: ["Быстрое питание", "Столовые"], indirect: ["Пиццерии", "Бургерные"] },
  restaurant: { direct: ["Рестораны", "Бары"], indirect: ["Кафе", "Столовые"] },
  bakery: { direct: ["Пекарни", "Кондитерские"], indirect: ["Кофейни", "Кафе"] },
  pizza: { direct: ["Пиццерии"], indirect: ["Быстрое питание", "Бургерные"] },
  burger: { direct: ["Бургерные"], indirect: ["Быстрое питание", "Пиццерии"] },
  sushi: { direct: ["Суши-бары", "Японская кухня"], indirect: ["Рестораны", "Кафе"] },
  canteen: { direct: ["Столовые"], indirect: ["Кафе", "Быстрое питание"] },
  bar: { direct: ["Бары", "Пабы"], indirect: ["Рестораны", "Караоке"] },
  confectionery: { direct: ["Кондитерские", "Кафе-кондитерские"], indirect: ["Пекарни", "Кофейни"] },

  // Красота
  barbershop: { direct: ["Барбершопы", "Парикмахерские"], indirect: ["Салоны красоты"] },
  beauty_salon: { direct: ["Салоны красоты", "Парикмахерские"], indirect: ["Косметология", "Маникюр"] },
  nails: { direct: ["Маникюр", "Педикюр", "Ногтевые студии"], indirect: ["Салоны красоты"] },
  cosmetology: { direct: ["Косметология", "Косметологические клиники"], indirect: ["Салоны красоты", "СПА"] },

  // Медицина
  dental: { direct: ["Стоматологии", "Стоматологические клиники"], indirect: ["Медицинские центры"] },
  pharmacy: { direct: ["Аптеки"], indirect: ["Медицинские центры", "Оптики"] },
  med_center: { direct: ["Медицинские центры", "Поликлиники"], indirect: ["Стоматологии", "Лаборатории"] },

  // Торговля
  grocery: { direct: ["Продуктовые магазины", "Супермаркеты"], indirect: ["Минимаркеты"] },
  clothing: { direct: ["Магазины одежды"], indirect: ["Обувные магазины", "Бутики"] },
  flowers: { direct: ["Цветочные магазины"], indirect: ["Подарки", "Сувениры"] },
  pet_shop: { direct: ["Зоомагазины"], indirect: ["Ветеринарные клиники"] },

  // Услуги
  car_wash: { direct: ["Автомойки"], indirect: ["Автосервисы", "Шиномонтажи"] },
  dry_cleaning: { direct: ["Химчистки", "Прачечные"], indirect: ["Ателье"] },
  photo_studio: { direct: ["Фотостудии"], indirect: ["Фотоуслуги", "Типографии"] },

  // Спорт
  gym: { direct: ["Фитнес-клубы", "Тренажёрные залы"], indirect: ["Йога-студии", "Бассейны"] },
  yoga: { direct: ["Йога-студии"], indirect: ["Фитнес-клубы", "Танцевальные студии"] },

  // Дети
  kids_center: { direct: ["Детские развивающие центры"], indirect: ["Детские сады", "Игровые комнаты"] },
  kindergarten: { direct: ["Детские сады"], indirect: ["Детские развивающие центры"] },
};
